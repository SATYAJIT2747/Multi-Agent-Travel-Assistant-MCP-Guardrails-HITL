...
# User asks:
# "Find flights from Bangladesh to Japan"
#         │
#         ▼
# ┌───────────────────────┐
# │   search_flights()    │  ← MAIN FUNCTION / TOOL
# └───────────┬───────────┘
#             │
#             ▼
# ┌───────────────────────┐
# │    parse_route()      │  ← Understand the user query
# └───────────┬───────────┘
#             │
#             ▼
#    Bangladesh + Japan
...
#             ▼
# ┌────────────────────────────┐
# │ resolve_location_to_iata() │  ← Convert location → airport code
# └───────────┬────────────────┘
#             │
#             ▼
#       DAC + NRT
...
#             ▼
# ┌────────────────────────┐
# │  AviationStack API     │  ← Get live flight data
# └───────────┬────────────┘
#             │
#             ▼
#         Raw JSON
...
#             ▼
# ┌────────────────────────┐
# │   format_flight()      │  ← Make data readable
# └───────────┬────────────┘
#             │
#             ▼
